...
<strong>
<ul>
<li>Pandas</li></ul> pour la manipulation des données. 
<li>Plotly</li></ul> Express pour la visualisation des données. 
<li>Streamlit</li> </ul>pour créer l'application web interactive.
</ul>
</strong>
